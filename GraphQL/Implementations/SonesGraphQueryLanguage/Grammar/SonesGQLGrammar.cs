...
namespace sones.GraphDB.GraphQL
{
    ...
    public class GraphQueryLanguage : Grammar //, IDumpable, IExtendableGrammar
    {
        ...
        private const String TERMINAL_BRACKET_LEFT = "(";
        private const String TERMINAL_BRACKET_RIGHT = ")";
        private const String TERMINAL_QUEUESIZE = "QUEUESIZE";
        private const String TERMINAL_WEIGHTED = "WEIGHTED";
        private const String TERMINAL_UNIQUE = "UNIQUE";
        private const String TERMINAL_MANDATORY = "MANDATORY";
        private const String TERMINAL_SORTED = "SORTED";
        private const String TERMINAL_ASC = "ASC";
        private const String TERMINAL_DESC = "DESC";
        private const String TERMINAL_TRUE = "TRUE";
        private const String TERMINAL_FALSE = "FALSE";
        private const String TERMINAL_LIST = "LIST";
        private const String TERMINAL_SET = "SET";
        private const String TERMINAL_LT = "<";
        private const String TERMINAL_GT = ">";
        ...
        private KeyTerm S_TUPLE_BRACKET_RIGHT_EXCLUSIVE
        {
            ...
            : base(false)
        {
            ...
            // todo: nachschlagen bzgl. LanguageFlags
            ...
            S_edgeInformationDelimiterSymbol = ToTerm(DBConstants.EdgeInformationDelimiterSymbol);
            S_edgeTraversalDelimiter = ToTerm(DBConstants.EdgeTraversalDelimiterSymbol);
            S_NULL = ToTerm("NULL");
            S_NOT = ToTerm("NOT");
            ...
            S_LISTOF = ToTerm(DBConstants.LISTOF);
            S_SETOF = ToTerm(DBConstants.SETOF);
            S_SETOFUUIDS = ToTerm(DBConstants.SETOFUUIDS);
            S_UUID = ToTerm("UUID");
            ...
            S_TRANSACTDISTRIBUTED = ToTerm(DBConstants.TRANSACTION_DISTRIBUTED);
            S_TRANSACTLONGRUNNING = ToTerm(DBConstants.TRANSACTION_LONGRUNNING);
            S_TRANSACTISOLATION = ToTerm(DBConstants.TRANSACTION_ISOLATION);
            S_TRANSACTNAME = ToTerm(DBConstants.TRANSACTION_NAME);
            S_TRANSACTTIMESTAMP = ToTerm(DBConstants.TRANSACTION_TIMESTAMP);
            S_TRANSACTROLLBACK = ToTerm(DBConstants.TRANSACTION_ROLLBACK);
            S_TRANSACTCOMMIT = ToTerm(DBConstants.TRANSACTION_COMMIT);
            S_TRANSACTCOMROLLASYNC = ToTerm(DBConstants.TRANSACTION_COMROLLASYNC);
            S_ADDTOLIST = ToTerm("+=");
        ...
        //public ExportGraphDDL(DumpFormats myDumpFormat, DBContext myDBContext, IEnumerable<GraphDBType> myTypesToDump)
        //{
        ...
        /// <returns></returns>
        //public ExportGraphDML(DumpFormats myDumpFormat, DBContext dbContext, IEnumerable<GraphDBType> myTypesToDump)
        //{
