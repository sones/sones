...
{
    /// <summary>
    /// Adds attributes to a edge
    /// </summary>
    public sealed class AlterEdgeType_AddAttributes : AAlterTypeCommand
    {

        public readonly List<AttributeDefinition> ListOfAttributes;

        public AlterEdgeType_AddAttributes(List<AttributeDefinition> listOfAttributes)
        {
