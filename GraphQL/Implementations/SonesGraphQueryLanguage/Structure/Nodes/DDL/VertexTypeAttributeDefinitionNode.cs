...
namespace sones.GraphQL.Structure.Nodes.DDL
{
    ...
    /// </summary>
    public sealed class VertexTypeAttributeDefinitionNode : AStructureNode, IAstNodeInit
    {

        #region constructor

        public VertexTypeAttributeDefinitionNode()
        { }
        ...
        {
            AttributeDefinition = new AttributeDefinition(((VertexTypeNode)parseNode.ChildNodes[0].AstNode).DBTypeDefinition, 
