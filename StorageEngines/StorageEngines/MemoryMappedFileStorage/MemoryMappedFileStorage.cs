...
//using sones.StorageEngines.FileStorage;
...
//    /// <summary>
//    /// This class maintains a PandoraFS filesystem within a normal file of the underlying filesystem
//    /// </summary>
...
//        #region MemoryMappedFileStorage(myStorage, myNumberOfBytes, myBufferSize, myOverwriteExistingFilesystem, myAction)
...
//        public MemoryMappedFileStorage(String myStorage, UInt64 myNumberOfBytes, UInt32 myBufferSize, Boolean myOverwriteExistingFilesystem, Action<Double> myAction)
//        {
