...
namespace sones.GraphDB.Managers.AlterType
{
    ...
    internal class AlterType_SetUnique : AAlterTypeCommand
    {
        ...
        {
            return graphDBType.ChangeUniqueAttributes(UniqueAttributes, dbContext.DBTypeManager);
        }
    ...
    internal class AlterType_SetMandatory : AAlterTypeCommand
    {
    ...
    internal class AlterType_DropUnique : AAlterTypeCommand
    {
    ...
    internal class AlterType_DropMandatory : AAlterTypeCommand
    {
    ...
    internal class AlterType_RenameBackwardedge : AAlterTypeCommand
    {
    ...
    internal class AlterType_RenameAttribute : AAlterTypeCommand
    {
    ...
    internal class AlterType_RenameType : AAlterTypeCommand
    {
    ...
    internal class AlterType_ChangeComment : AAlterTypeCommand
    {
    ...
    internal class AlterType_DropAttributes : AAlterTypeCommand
    {
    ...
    internal class AlterType_DropIndices : AAlterTypeCommand
    {
    ...
    internal class AlterType_AddIndices : AAlterTypeCommand
    {
    ...
    internal class AlterType_AddAttributes : AAlterTypeCommand
    {
    ...
    internal class AlterType_DefineAttributes : AAlterTypeCommand
    {
        #region data
    ...
    internal class AlterType_UndefineAttributes : AAlterTypeCommand
    {
        #region data
