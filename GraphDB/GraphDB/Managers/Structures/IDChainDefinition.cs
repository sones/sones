...
namespace sones.GraphDB.Managers.Structures
{
    ...
    public class ChainPartFuncDefinition : AIDChainPart
    {
        ...
        public Exceptional<FuncParameter> Execute(GraphDBType myTypeOfDBObject, DBObjectStream myDBObject, String myReference, DBContext dbContext, DBObjectCache dbObjectCache)
        {
