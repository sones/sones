                ...
                if (referenceUUIDs != null)
                {
                    ...
                    foreach (var aReferenceUUID in referenceUUIDs)
                    {
                        ...
                        if (!tempDbo.Success)
                        {
                            ...
                            {
                                invalidReferenceSetting = (SettingInvalidReferenceHandling)_DBContext.DBSettingsManager.GetSetting(SettingInvalidReferenceHandling.UUID, _DBContext, Enums.TypesSettingScope.ATTRIBUTE, referenceType, tempTypeAttribute).Value;
                            }
