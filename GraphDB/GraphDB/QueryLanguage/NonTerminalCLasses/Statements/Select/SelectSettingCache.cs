...
namespace sones.GraphDB.QueryLanguage.NonTerminalCLasses.Statements.Select
{
    ...
    public class SelectSettingCache
    {
        ...
        public ADBBaseObject GetValue(GraphDBType myTypeID, TypeAttribute myAttrID, UUID mySettingUUID, DBContext context)
        {
            ...
            var settingValue = context.DBSettingsManager.GetSettingValue(mySettingUUID, context, Enums.TypesSettingScope.ATTRIBUTE, myTypeID, myAttrID).Value.Clone();
