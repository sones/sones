...
/* <id name="PandoraDB – OutputDictionary" />
...
{    
    [Serializable]
    public class OutputDictionary : AObject
    {
        ...
        public Dictionary<String, AObject> Dictionary { get; set; }
        public OutputDictionary(Dictionary<String, AObject> myDict)
        {
            Dictionary = myDict;
        }
