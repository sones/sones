...
namespace sones.GraphDB.ErrorHandling
{
    ...
    /// </summary>
    public sealed class InvalidDefineAttributeTypeException : AGraphDBVertexTypeException
    {
        ...
        public InvalidDefineAttributeTypeException(String myAttributeType, String myBaseVertexTypeName)
        {
            BaseVertexTypeName = myBaseVertexTypeName;
            _msg = String.Format("Define attribute of type {0} is not supported.", myAttributeType);
        }
