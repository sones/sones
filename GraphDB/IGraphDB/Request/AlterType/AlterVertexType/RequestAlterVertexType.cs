...
namespace sones.GraphDB.Request
{
    ...
    /// </summary>
    public sealed class RequestAlterVertexType : IRequestAlterType
    {
        #region Data
        ...
        public int AddUniqueCount
        {
            get;
            private set;
        }
        public int AddMandatoryCount
        {
            get;
            private set;
        }
        public int AddIndicesCount
        {
            get;
            private set;
        }
        ...
        public IEnumerable<OutgoingEdgePredefinition> ToBeAddedOutgoingEdges
        {
            get 
            { 
                return (_toBeAddedAttributes == null) ? null : _toBeAddedAttributes.OfType<OutgoingEdgePredefinition>(); 
            }
        }
        ...
        public IEnumerable<IncomingEdgePredefinition> ToBeAddedIncomingEdges
        {
            get
            { 
                return (_toBeAddedAttributes == null) ? null : _toBeAddedAttributes.OfType<IncomingEdgePredefinition>();
            }
        }
        ...
        public IEnumerable<IndexPredefinition> ToBeAddedIndices
        {
            get 
            { 
                return (_toBeAddedIndices == null) ? null : _toBeAddedIndices.AsReadOnly(); 
            }
        }
        ...
        public IEnumerable<UniquePredefinition> ToBeAddedUniques
        {
            get 
            { 
                return (_toBeAddedUniques == null) ? null : _toBeAddedUniques.AsReadOnly(); 
            }
        }
        ...
        public IEnumerable<MandatoryPredefinition> ToBeAddedMandatories
        {
            get 
            { 
                return (_toBeAddedMandatories == null) ? null : _toBeAddedMandatories.AsReadOnly(); 
            }
        }
        ...
        public IEnumerable<BinaryPropertyPredefinition> ToBeAddedBinaryProperties
        {
            get 
            { 
                return (_toBeAddedAttributes == null) ? null : _toBeAddedAttributes.OfType<BinaryPropertyPredefinition>();
            }
        }
        ...
        public IEnumerable<String> ToBeRemovedOutgoingEdges
        {
            get 
            { 
                return _toBeRemovedOutgoingEdges; 
            }
        }
        ...
        public IEnumerable<String> ToBeRemovedBinaryProperties
        {
            get 
            { 
                return _toBeRemovedBinaryProperties; 
            }
        }
        ...
        public IEnumerable<String> ToBeRemovedIncomingEdges
        {
            get 
            { 
                return _toBeRemovedIncomingEdges; 
            }
        }
        ...
        public IEnumerable<String> ToBeRemovedMandatories
        {
            get 
            { 
                return _toBeRemovedMandatories; 
            }
        }
