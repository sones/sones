...
namespace sones.GraphDB.Request
{
    ...
    public sealed class VertexInsert
    {
        ...
        /// </summary>
        public readonly Boolean IsUserGeneratedName = false;
        ...
        {
            this.StructuredProperties.Add(myPropertyName, myProperty);
        ...
        {
            this.UnstructuredProperties.Add(myPropertyName, myProperty);
        ...
        {
            this.BinaryProperties.Add(myPropertyName, myStream);
        ...
        {
            this.AddEdge(myEdgeName, myEdgeDefinition);
