...
namespace sones.GraphDB.Request
{
    ...
    public sealed class PipelineableCreateVertexTypeRequest : APipelinableRequest
    {
        ...
        {
            myMetaManager.VertexTypeManager.CanAddVertexTypes(new List<VertexTypePredefinition> { _request.VertexTypeDefinition }, TransactionToken, SecurityToken);
        }

        public override void Execute(IMetaManager myMetaManager)
        {
            _createdVertexType = myMetaManager.VertexTypeManager.AddVertexTypes(new List<VertexTypePredefinition> { _request.VertexTypeDefinition }, TransactionToken, SecurityToken).FirstOrDefault();
        }
