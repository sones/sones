...
{
    internal sealed class OutgoingEdgeVertexType: TypeBase, IVertexType
    {
        #region Data

        private static readonly IEnumerable<IVertexType> _Childs = new IVertexType[0]; 

        private static readonly IEnumerable<IAttributeDefinition> _Attributes = new IAttributeDefinition[]
        {
            AttributeDefinitions.EdgeTypeOnOutgoingEdge,
            AttributeDefinitions.SourceOnOutgoingEdge,
            AttributeDefinitions.TargetOnOutgoingEdge,
            AttributeDefinitions.RelatedIncomingEdgesOnOutgoingEdge
        };
        ...
        internal OutgoingEdgeVertexType() : base(_Attributes, _Parent.GetAttributeDefinitions(true)) { }
        ...
        long IVertexType.ID
        {
            get { return (long)BaseVertexType.OutgoingEdge; }
        }

        string IVertexType.Name
        {
            get { return "OutgoingEdge"; }
        }
