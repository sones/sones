...
namespace sones.GraphDB.Manager.Index
{
    ...
    public sealed class IndexManager : IIndexManager, IManager
    {
        ...
        {
            myVertexType.CheckNull("myVertexType");
            return myVertexType.GetIndexDefinitions(false).Where(_=>!_.IndexedProperties.CountIsGreater(1) && _.IndexedProperties.Contains(myPropertyDefinition)).Select(_ => _indices[_.ID]);
