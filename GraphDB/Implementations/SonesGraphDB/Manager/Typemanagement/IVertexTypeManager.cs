...
namespace sones.GraphDB.Manager.TypeManagement
{
    public interface IVertexTypeManager: IStorageUsingManager
    {
        ...
        /// <see cref="RemoveVertex(System.Collections.Generic.IEnumerable{sones.GraphDB.TypeSystem.IVertexType}, sones.Library.Transaction.TransactionToken,sones.Library.Security.SecurityToken,sones.GraphDB.Manager.MetaManager)" />.
