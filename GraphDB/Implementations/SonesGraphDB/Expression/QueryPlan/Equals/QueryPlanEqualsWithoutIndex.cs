...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanEqualsWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ConstantExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
