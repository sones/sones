...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanEqualsWithIndex : AComparativeIndexOperator, IQueryPlan
    {
        ...
        public QueryPlanEqualsWithIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ConstantExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning, IIndexManager myIndexManager)
