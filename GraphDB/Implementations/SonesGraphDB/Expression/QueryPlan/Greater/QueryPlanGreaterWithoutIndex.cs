...
{
    /// <summary>
    /// An Greater operation without any index
    /// </summary>
    public sealed class QueryPlanGreaterThanWithoutIndex : AComparativeOperator, IQueryPlan
    {
        #region constructor

        /// <summary>
        /// Creates a new queryplan that processes an greater operation without any index
        /// </summary>
        ...
        public QueryPlanGreaterThanWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, QueryPlanConstant myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
