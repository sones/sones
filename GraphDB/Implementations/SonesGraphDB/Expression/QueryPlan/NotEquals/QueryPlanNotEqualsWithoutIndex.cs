...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanNotEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanNotEqualsWithoutIndex(SecurityToken mySecurityToken, Int64 myTransactionToken, QueryPlanProperty myProperty, ILiteralExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
