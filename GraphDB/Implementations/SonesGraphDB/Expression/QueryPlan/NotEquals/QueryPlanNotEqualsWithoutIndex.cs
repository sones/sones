...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanNotEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanNotEqualsWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, QueryPlanConstant myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
