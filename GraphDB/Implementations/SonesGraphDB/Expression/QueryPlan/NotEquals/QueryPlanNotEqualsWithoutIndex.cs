...
{
    /// <summary>
    /// A not equals operation without any index
    /// </summary>
    public sealed class QueryPlanNotEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        #region constructor

        /// <summary>
        /// Creates a new queryplan that processes a not equals operation without any index
        /// </summary>
        ...
        public QueryPlanNotEqualsWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ILiteralExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
