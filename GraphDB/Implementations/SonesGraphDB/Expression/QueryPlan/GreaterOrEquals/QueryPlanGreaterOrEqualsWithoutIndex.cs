...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanGreaterOrEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanGreaterOrEqualsWithoutIndex(SecurityToken mySecurityToken, Int64 myTransactionToken, QueryPlanProperty myProperty, ILiteralExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
