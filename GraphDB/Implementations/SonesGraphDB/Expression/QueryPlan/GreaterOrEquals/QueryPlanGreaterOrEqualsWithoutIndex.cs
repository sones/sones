...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanGreaterOrEqualsWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanGreaterOrEqualsWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ConstantExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
