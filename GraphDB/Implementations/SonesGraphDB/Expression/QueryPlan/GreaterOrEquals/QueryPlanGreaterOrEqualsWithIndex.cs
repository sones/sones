...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanGreaterOrEqualsWithIndex : AComparativeIndexOperator, IQueryPlan
    {
        ...
        public QueryPlanGreaterOrEqualsWithIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ConstantExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning, IIndexManager myIndexManager)
