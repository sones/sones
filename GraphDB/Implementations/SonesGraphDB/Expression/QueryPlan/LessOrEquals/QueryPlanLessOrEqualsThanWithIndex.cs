...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanLessOrEqualsThanWithIndex : AComparativeIndexOperator, IQueryPlan
    {
        ...
        public QueryPlanLessOrEqualsThanWithIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ILiteralExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning, IIndexManager myIndexManager)
