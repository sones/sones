...
{
    /// <summary>
    /// A less or equals than operation without any index
    /// </summary>
    public sealed class QueryPlanLessOrEqualsThanWithoutIndex : AComparativeOperator, IQueryPlan
    {
        #region constructor
        ...
        public QueryPlanLessOrEqualsThanWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, ILiteralExpression myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
