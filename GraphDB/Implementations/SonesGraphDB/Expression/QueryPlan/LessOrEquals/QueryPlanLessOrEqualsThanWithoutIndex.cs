...
namespace sones.GraphDB.Expression.QueryPlan
{
    ...
    public sealed class QueryPlanLessOrEqualsThanWithoutIndex : AComparativeOperator, IQueryPlan
    {
        ...
        public QueryPlanLessOrEqualsThanWithoutIndex(SecurityToken mySecurityToken, TransactionToken myTransactionToken, QueryPlanProperty myProperty, QueryPlanConstant myConstant, IVertexStore myVertexStore, Boolean myIsLongrunning)
