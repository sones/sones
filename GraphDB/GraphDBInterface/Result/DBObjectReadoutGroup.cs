...
namespace sones.GraphDBInterface.Result
{
    ...
    public class DBObjectReadoutGroup : DBObjectReadout
    {
        ...
        public IEnumerable<DBObjectReadout> GroupedVertices { get; protected set; }

        public DBObjectReadoutGroup(IDictionary<String, Object> myAttributes, IEnumerable<DBObjectReadout> myGroupedVertices)
            : base (myAttributes)
        {
