...
namespace sones.Plugins.SonesGQL.Function.ErrorHandling
{
    ...
    public sealed class UnknownFunctionException : ASonesQLFunctionException
    {
        ...
        public UnknownFunctionException(Exception innerException = null) : base(innerException)
        {
            _msg = "An unknown function error has occurred. See InnerException for details";
        }
