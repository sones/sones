...
namespace sones.Plugins.Index
{
        ...
        where TVersion : IComparable
    {
        ...
        public IEnumerable<ISet<TValue>> GreaterThan(TKey myKey, TVersion myVersion, bool myOrEqual = true)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<ISet<TValue>> LowerThan(TKey myKey, TVersion myVersion, bool myOrEqual = true)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<ISet<TValue>> InRange(TKey myFromKey, TKey myToKey, TVersion myVersion,
        ...
        public void Add(TKey myKey, ISet<TValue> myValue, TVersion myVersion,
                        IndexAddStrategy myIndexAddStrategy = IndexAddStrategy.UNIQUE)
        {
            throw new NotImplementedException();
        }

        public void Add(KeyValuePair<TKey, ISet<TValue>> myKeyValuePair, TVersion myVersion,
                        IndexAddStrategy myIndexAddStrategy = IndexAddStrategy.UNIQUE)
        {
            throw new NotImplementedException();
        }

        public void Add(Dictionary<TKey, ISet<TValue>> myDictionary, TVersion myVersion,
                        IndexAddStrategy myIndexAddStrategy = IndexAddStrategy.UNIQUE)
        {
            throw new NotImplementedException();
        }

        public ISet<TValue> this[TKey myKey, TVersion myVersion]
        {
            get { throw new NotImplementedException(); }
            set { throw new NotImplementedException(); }
        }

        public IEnumerable<ISet<TValue>> Values(TVersion myVersion)
        {
            throw new NotImplementedException();
        }

        public ISet<TKey> Keys(TVersion myVersion)
        {
            throw new NotImplementedException();
        }
