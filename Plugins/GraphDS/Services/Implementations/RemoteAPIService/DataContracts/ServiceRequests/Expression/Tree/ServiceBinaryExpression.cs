...
namespace sones.GraphDS.Services.RemoteAPIService.DataContracts.ServiceRequests.Expression
{
    ...
    public class ServiceBinaryExpression : ServiceBaseExpression
    {
        ...
        /// </summary>
        [DataMember]
        public ServiceBaseExpression Left;

        /// <summary>
        /// The binary operator
        /// </summary>
        [DataMember]
        public ServiceBinaryOperator Operator;

        /// <summary>
        /// The right side of the BinaryExpression
        /// </summary>
        [DataMember]
        public ServiceBaseExpression Right;
