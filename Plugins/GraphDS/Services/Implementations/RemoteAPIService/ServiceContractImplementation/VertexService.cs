...
namespace sones.GraphDS.Services.RemoteAPIService.ServiceContractImplementation
{
    ...
    {
        public bool HasIncomingVertices(SecurityToken mySecToken, Int64 myTransToken,
            long myVertexTypeID, ServiceVertexInstance myVertex, long myEdgePropertyID)
        {
            ...
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
            return Response.HasIncomingVertices(myVertexTypeID, myEdgePropertyID);
        }

        public List<Tuple<long, long, List<ServiceVertexInstance>>> GetAllIncomingVertices(SecurityToken mySecToken, Int64 myTransToken,
        ...
        public List<ServiceVertexInstance> GetIncomingVertices(SecurityToken mySecToken, Int64 myTransToken,
            long myVertexTypeID, ServiceVertexInstance myVertex, long myEdgePropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public bool HasOutgoingEdge(SecurityToken mySecToken, Int64 myTransToken,
        ...
        public List<Tuple<long, ServiceEdgeInstance>> GetAllOutgoingEdges(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public List<Tuple<long, ServiceHyperEdgeInstance>> GetAllOutgoingHyperEdges(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public List<Tuple<long, ServiceSingleEdgeInstance>> GetAllOutgoingSingleEdges(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public ServiceEdgeInstance GetOutgoingEdge(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myEdgePropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public ServiceHyperEdgeInstance GetOutgoingHyperEdge(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myEdgePropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public ServiceSingleEdgeInstance GetOutgoingSingleEdge(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myEdgePropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public System.IO.Stream GetBinaryProperty(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myPropertyID)
        {
            throw new NotImplementedException();
        }

        public List<Tuple<long, System.IO.Stream>> GetAllBinaryProperties(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            throw new NotImplementedException();
        }

        public object GetProperty(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myPropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public bool HasProperty(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myPropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public int GetCountOfProperties(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public List<Tuple<long, object>> GetAllProperties(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public string GetPropertyAsString(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, long myPropertyID)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public object GetUnstructuredProperty(SecurityToken mySecToken, Int64 myTransToken,
        ...
        public bool HasUnstructuredProperty(SecurityToken mySecToken, Int64 myTransToken,
            ServiceVertexInstance myVertex, string myPropertyName)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public int GetCountOfUnstructuredProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public List<Tuple<string, object>> GetAllUnstructuredProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public string GetUnstructuredPropertyAsString(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex, string myPropertyName)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public string Comment(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public long CreationDate(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
        ...
        public long ModificationDate(SecurityToken mySecToken, Int64 myTransToken, ServiceVertexInstance myVertex)
        {
            var Request = ServiceRequestFactory.MakeRequestGetVertex(myVertex.TypeID, myVertex.VertexID);
            var Response = this.GraphDS.GetVertex<IVertex>(mySecToken, myTransToken, Request, ServiceReturnConverter.ConvertOnlyVertexInstance);
