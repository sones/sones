...
namespace sones.GraphDS.Services.RemoteAPIService.ServiceContracts.EdgeInstanceService
{
    ...
    public interface IEdgeService 
    {
        ...
        object GetProperty(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, Int64 myPropertyID);
        ...
        bool HasProperty(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, Int64 myPropertyID);
        ...
        int GetCountOfProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        List<Tuple<Int64, object>> GetAllProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        String GetPropertyAsString(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, Int64 myPropertyID);
        ...
        object GetUnstructuredProperty(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, string myPropertyName);
        ...
        bool HasUnstructuredProperty(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, String myPropertyName);
        ...
        int GetCountOfUnstructuredProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        List<Tuple<String, Object>> GetAllUnstructuredProperties(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        String GetUnstructuredPropertyAsString(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement, String myPropertyName);
        ...
        String Comment(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        long CreationDate(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
        ...
        long ModificationDate(SecurityToken mySecToken, Int64 myTransToken, ServiceEdgeInstance myGraphElement);
