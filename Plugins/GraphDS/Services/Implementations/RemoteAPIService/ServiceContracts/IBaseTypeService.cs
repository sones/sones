...
namespace sones.GraphDS.Services.RemoteAPIService.ServiceContracts.VertexTypeServices
{
    ...
    public interface IBaseTypeService
    {
        ...
        /// </value>
        [OperationContract]
        Boolean IsSealed(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType);
        ...
        [OperationContract]
        bool HasParentType(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType);
        ...
        [OperationContract]
        bool HasChildTypes(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType);
        ...
        [OperationContract]
        bool IsAncestor(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType, ServiceBaseType myOtherType);
        ...
        [OperationContract]
        bool IsAncestorOrSelf(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType, ServiceBaseType myOtherType);
        ...
        [OperationContract]
        bool IsDescendant(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType, ServiceBaseType myOtherType);
        ...
        [OperationContract]
        bool IsDescendantOrSelf(SecurityToken mySecToken, ServiceTransactionToken myTransToken, ServiceBaseType myServiceType, ServiceBaseType myOtherType);
