    ...
    public class GraphAppSettings
    {
            ...
            where T1 : IGraphSetting, new()
        {
            ...
            lock (_Settings)
            {
                ...
                {
                    _Settings.Add(IGraphDSSetting.SettingName, new CurrentSetting() { IGraphDSSetting = IGraphDSSetting, CurrentValue = IGraphDSSetting.DefaultSettingValue, GraphDSSettingChangingEvent = null });
                }
