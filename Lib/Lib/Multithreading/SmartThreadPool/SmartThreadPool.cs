...
using sones.Lib.Threading.Internal;
...
namespace sones.Lib.Threading
{
	...
	/// </summary>
	public class SmartThreadPool : AWorkItemsGroupBase, IDisposable
	{
        ...
        private class ThreadEntry
        {
            ...
            {
                _lastAliveTime = TimestampNonce.Now;
            }
        }
		...
		public void Shutdown(bool forceAbort, int millisecondsTimeout)
		{
            ...
            DateTime start = TimestampNonce.Now;
			...
			foreach(Thread thread in threads)
			{
				...
				if(!waitInfinitely)
				{
                    ...
                    TimeSpan ts = TimestampNonce.Now - start;
