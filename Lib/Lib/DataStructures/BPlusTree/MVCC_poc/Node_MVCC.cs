...
{
    abstract class Node_MVCC<TKey, TValue>
        where TKey : IComparable
    {
        ...
        /// </summary>
        private Node_MVCC<TKey, TValue> _Parent;

        /// <summary>
        /// Holds a reference to the right Node
        /// </summary>
        private Node_MVCC<TKey, TValue> _RightSibling;

        /// <summary>
        /// Holds a reference to the left Node
        /// </summary>
        private Node_MVCC<TKey, TValue> _LeftSibling;
        ...
        /// </summary>
        protected BPlusTree_MVCC<TKey, TValue> _CorrespondingTree;
        ...
        /// </summary>
        public Node_MVCC(BPlusTree_MVCC<TKey, TValue> myTree)
        {
        ...
        /// </summary>
        public Node_MVCC<TKey, TValue> RightSibling
        {
        ...
        /// </summary>
        public Node_MVCC<TKey, TValue> LeftSibling
        {
        ...
        /// </summary>
        public Node_MVCC<TKey, TValue> Parent
        {
            get { return _Parent; }
            set { _Parent = value; }
        }
        ...
        protected abstract void Transfer(int mySourceStartIndex, int myDestinationStartIndex, int myLength, Node_MVCC<TKey, TValue> myDestinationNode);
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract Node_MVCC<TKey, TValue> Clone();
        ...
        /// </summary>
        /// <returns></returns>
        protected Node_MVCC<TKey, TValue> GetFullerSibling()
        {
            //left
        ...
        public Node_MVCC<TKey, TValue> Remove(ref TKey myKey, Node_MVCC<TKey, TValue> myLeftSibling, Node_MVCC<TKey, TValue> myRightSibling, Node_MVCC<TKey, TValue> myLeftAnchestor, Node_MVCC<TKey, TValue> myRightAnchestor, Node_MVCC<TKey, TValue> myParentNode, ref bool myRemovedFlag)
        {
            #region data

            //used to go down the tree
            Node_MVCC<TKey, TValue> childNode;
            //left child
            Node_MVCC<TKey, TValue> childsLeftNode, childsLeftAnchor;
            //right child
            Node_MVCC<TKey, TValue> childsRightNode, childsRightAnchor;
            //the node where the key has been removed
            Node_MVCC<TKey, TValue> removeNode;           
            ...
            if (this is InnerNode_MVCC<TKey, TValue>)
            {
                var currentNode = this as InnerNode_MVCC<TKey, TValue>;
                ...
                childsLeftNode     = (leftSlot >= -1)        ? currentNode.Children[keySlot]     : (_LeftSibling != null)    ? (_LeftSibling as InnerNode_MVCC<TKey, TValue>).Children[_LeftSibling.KeyCount] : null;
                ...
                childsRightNode    = (rightSlot < _KeyCount) ? currentNode.Children[keySlot + 2] : (_RightSibling != null)   ? (_RightSibling as InnerNode_MVCC<TKey, TValue>).Children[0] : null;
            ...
            else
            {
                ...
                if (notLeft && notRight)
                {
                    ...
                    if (this is LeafNode_MVCC<TKey, TValue>)
                    {
                        removeNode = null;
                    }
                    else
                    {
                        ...
                        removeNode = (IsEmpty()) ? (this as InnerNode_MVCC<TKey, TValue>).Children[0] : null;
                    }
        ...
        /// <returns></returns>
        private Node_MVCC<TKey, TValue> Shift(Node_MVCC<TKey, TValue> myLeftNode, Node_MVCC<TKey, TValue> myRightNode, Node_MVCC<TKey, TValue> myAnchor)
        {
            #region data
            ...
            bool isInternal = myLeftNode is InnerNode_MVCC<TKey, TValue>;
            ...
            if (myLeftNode.KeyCount < myRightNode.KeyCount)
            {
                ...
                if (isInternal)
                {
                    ...
                    var tmpLeft = myLeftNode as InnerNode_MVCC<TKey, TValue>;
                    var tmpRight = myRightNode as InnerNode_MVCC<TKey, TValue>;
                    /*
        ...
        private Node_MVCC<TKey, TValue> Merge(Node_MVCC<TKey, TValue> myLeftNode, Node_MVCC<TKey, TValue> myRightNode, Node_MVCC<TKey, TValue> myAnchor, ref TKey myRemoveKey)
        {                       
            Debug.WriteLine("----------------");
            ...
            if (isInternal)
            {
                ...
                ((InnerNode_MVCC<TKey, TValue>)myLeftNode).Children[myLeftNode.KeyCount] = ((InnerNode_MVCC<TKey, TValue>)myRightNode).Children[0];
        ...
        where TKey : IComparable
    {
        ...
        /// </summary>
        private Node_MVCC<TKey, TValue> _Node;
        ...
        /// </summary>
        public Node_MVCC<TKey, TValue> Node
        {
            get { return _Node; }
            set { _Node = value; }
        }
