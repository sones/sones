...
namespace sones.Lib.Frameworks.Irony.Parsing {
  ...
  //  private IContext _context;
    ...
    {
        ReportError(location, message, null, args);
    }
    public void ReportError(SourceLocation location, string message, Exception exception, params object[] args) {
        ReportError(null, location, message, exception, args); 
    }
    public void ReportError(ParserState state, SourceLocation location, string message, params object[] args)
    {
        ReportError(state, location, message, null, args);
    }
    /* Added by sones developers */
    /* Changed by sones developers */
    // Added 'Exception' to the method and pass the Exception to the SyntaxError ctor
    public void ReportError(ParserState state, SourceLocation location, string message, Exception exception, params object[] args)
    {
