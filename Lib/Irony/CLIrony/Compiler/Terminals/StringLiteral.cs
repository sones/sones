...
namespace sones.Lib.Frameworks.CLIrony.Compiler {
  ...
  public class StringLiteral : ACompoundTerminalBase {
    ...
    protected override void InitDetails(CompilerContext context, ACompoundTerminalBase.CompoundTokenDetails details) {
    ...
    protected override void ReadSuffix(ISourceStream source, ACompoundTerminalBase.CompoundTokenDetails details) {
