...
*/
  ...
  public abstract class ACompoundTerminalBase : Terminal {
    ...
    public ACompoundTerminalBase(String name, TermOptions options) : base(name) {
      SetOption(options);
      Escapes = TextUtils.GetDefaultEscapes();
    }
    public ACompoundTerminalBase(String name)  : this(name, TermOptions.None) {  }
