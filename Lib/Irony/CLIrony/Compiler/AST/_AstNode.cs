...
//Note - we put AstNode into CLIrony.CompilerServices namespace, not CLIrony.CompilerServices.AST, to reduce number of extra "using" 
...
namespace sones.Lib.Frameworks.CLIrony.Compiler {
  ...
  public class NodeArgs {
    ...
    public readonly ABnfTerm Term;
    public readonly SourceSpan Span;
    public readonly AstNodeList ChildNodes;

    public NodeArgs(CompilerContext context, ABnfTerm term, SourceSpan span, AstNodeList childNodes) {
      Context = context;
      Term = term;
      Span = span; 
