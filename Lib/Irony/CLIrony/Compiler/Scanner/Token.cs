...
namespace sones.Lib.Frameworks.CLIrony.Compiler {
  ...
  public class Token : AstNode  {
    ...
    public ACompoundTerminalBase.CompoundTokenDetails Details;
    ...
    private void EvaluateAssign(sones.Lib.Frameworks.CLIrony.Runtime.EvaluationContext context) {
      context.CurrentResult = this.Value;
    }
    private void EvaluateEmpty(sones.Lib.Frameworks.CLIrony.Runtime.EvaluationContext context) {
    }
