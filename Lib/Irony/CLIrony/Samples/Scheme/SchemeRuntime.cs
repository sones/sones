...
namespace sones.Lib.Frameworks.CLIrony.Samples.Scheme {
  ...
  public sealed class SchemeRuntime : sones.Lib.Frameworks.CLIrony.Runtime.LanguageRuntime {
    ...
    public override void Init() {
      ...
      // On the other hand, in CLIrony runtime library the comparison methods return CLR bool type by default. 
      // CLIrony can change the return values in these methods if we provide a custom result converter before the base.Init 
      // method is called.
      base.BoolResultConverter = BoolObjectToSchemeBool;
      base.Init();
      //In Scheme, the equality operator is "=", not "==" as in other languages. CLIrony runtime creates 
