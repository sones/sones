...
/* PandoraLib - UDPSocketMulticast<TServerLogic>
 * (c) Stefan Licht, 2009
 * 
 * This pattern creates a UDP Socket server. It will create a new instance of the
 * generic class TServerLogic and for each new UDP request, the DataReceived() method will
 * be invoked. The generic TServerLogic class must derive AUDPSocketConnection!
 * 
 * Lead programmer:
 *      Stefan Licht
 * 
