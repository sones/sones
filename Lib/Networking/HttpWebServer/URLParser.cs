...
/* <id name="Networking – URLParser" />
 * <copyright file="URLParser.cs"
 *            company="sones GmbH">
...
namespace sones.Networking.HTTP
{
    ...
    public class URLParser
    {
        ...
        public void AddUrl(string url, MethodInfo method, string webMethod = "GET", Boolean? needsExplicitAuthentication = null)
        {
