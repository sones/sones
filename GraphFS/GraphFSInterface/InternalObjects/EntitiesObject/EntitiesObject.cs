...
namespace sones.GraphFS.InternalObjects
{
    ...
    public class EntitiesObject : ADictionaryObject<EntityUUID, Entity>
    {
        ...
        public override ulong GetEstimatedSizeOfKey(EntityUUID myTKey)
        {
            return myTKey.GetEstimatedSize();
        }

        public override ulong GetEstimatedSizeOfValue(Entity myTValue)
        {
