...
namespace sones.GraphFS.InternalObjects
{
    ...
    public class MetadataObject<TValue> : AIndexObject<String, TValue>, IMetadataObject<TValue>, IDirectoryListing
    {
        ...
        #region MetadataObject(myObjectLocation)
        ...
        public MetadataObject(ObjectLocation myObjectLocation)
            : this()
        {
        ...
        #region MetadataObject(myObjectLocation, myObjectStream)

        /// <summary>
        /// This will create a MetadataObject with the given ObjectLocation and ObjectStream.
        /// </summary>
        /// <param name="myObjectLocation">the location of this object (ObjectPath and ObjectName) of the requested file within the file system</param>
        /// <param name="myObjectStream">the ObjectStream</param>
        public MetadataObject(ObjectLocation myObjectLocation, String myObjectStream)
        ...
        #region MetadataObject(myObjectLocation, myObjectStream, myObjectEdition)

        /// <summary>
        /// This will create a MetadataObject with the given ObjectLocation, ObjectStream and ObjectEdition.
        /// </summary>
        /// <param name="myObjectLocation">the location of this object (ObjectPath and ObjectName) of the requested file within the file system</param>
        /// <param name="myObjectStream">the ObjectStream</param>
        /// <param name="myObjectEdition">the ObjectEdition</param>
        public MetadataObject(ObjectLocation myObjectLocation, String myObjectStream, String myObjectEdition)
        ...
        #region MetadataObject(myObjectLocation, myObjectStream, myObjectEdition, myObjectRevisionID)

        /// <summary>
        /// This will create a MetadataObject with the given ObjectLocation, ObjectStream, ObjectEdition and ObjectRevisionID.
        /// </summary>
        /// <param name="myObjectLocation">the location of this object (ObjectPath and ObjectName) of the requested file within the file system</param>
        /// <param name="myObjectStream">the ObjectStream</param>
        /// <param name="myObjectEdition">the ObjectEdition</param>
        ...
        #region MetadataObject(myObjectLocation, myObjectRevisionID)
        ...
        public MetadataObject(ObjectLocation myObjectLocation, Byte[] mySerializedData, IIntegrityCheck myIntegrityCheckAlgorithm, ISymmetricEncryption myEncryptionAlgorithm)
            : this(myObjectLocation)
        {
