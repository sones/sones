...
/* PandoraFS - NAccessControl_AllowACL_EntityRemoved
 * (c) Henning Rauch, 2009
 * 
 * Notifies about a changed ACCESSCONTROLSTREAM. An Entity has been removed from the AllowACL.
 * 
 * Lead programmer:
 *      Henning Rauch
 * 
...
namespace sones.GraphFS.Notification
{
    ...
    /// Notifies about a changed ACCESSCONTROLSTREAM. An Entity has been removed from the AllowACL.
    /// </summary>
    public class NAccessControl_AllowACL_EntityRemoved : NAccessControl
    {
        ...
        public new class Arguments : INotificationArguments
        {
            ...
            public Byte[] Serialize()
            {
                ...
                _SerializationWriter.WriteObject(RightUUID.GetByteArray());
        ...
        {
            get { return "Notifies about a removed entity from AllowACL."; }
        }
