...
namespace sones.GraphFS.DataStructures
{
    ...
    /// <summary>
    ///  The ObjectCompression is a virtual directory to handle the
    ///  getting and setting of the compression type of an object.
    /// </summary>

    

    public class ObjectCompression : IDirectoryListing
    {


        #region Data

        public  CompressionTypes Algorithm;
        ...
        public Trinary ObjectExists(String myObjectName)
        {
            ...
            foreach (String item in Enum.GetNames(typeof(CompressionTypes)))
        ...
        public IEnumerable<String> GetDirectoryListing()
        {
            ...
            foreach (var item in Enum.GetNames(typeof(CompressionTypes)))
