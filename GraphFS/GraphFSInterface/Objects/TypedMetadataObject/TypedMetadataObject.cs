...
///* PandoraFS - ATypedMetadataObject
...
//using sones.Pandora.Storage.Exceptions;
//
//using sones.Lib.Serializer;

//using sones.Lib;
//using sones.Pandora.Storage.PandoraFS.GenericObjects;
...
//    /// and virtual metadata objects.
//    /// </summary>
//    public class TypedMetadataObject<T> : APandoraObject, IMetadataObject<T>, IDirectoryObject
//    {
...
//        public override APandoraStructure Clone()
//        {
...
//            if (isDirty || _SerializedAPandoraStructure == null)
//                Serialize();

//            TClone newT = new TClone();
//            newT.Deserialize(_SerializedAPandoraStructure, this);
...
//            _SerializedAPandoraStructure = _IndexObject.Serialize( (UInt64) _IMetadataObject_NotificationHandling);
//            //isDirty = false;
