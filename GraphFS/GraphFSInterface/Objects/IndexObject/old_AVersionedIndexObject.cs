...
///* PandoraFS - AVersionedIndexObject
...
//        //            throw new PandoraFSException_TypeParametersDiffer("Type parameter TKey of IndexObject_HashTable<" + typeof(TKey).ToString() + ", " + typeof(TValue).ToString() + "> is different from the serialized IndexObject_HashTable<" + KeyType.ToString() + ", " + ValueType.ToString() + ">!");

//        //        if (ValueType != typeof(TValue))
//        //            throw new PandoraFSException_TypeParametersDiffer("Type parameter PT of IndexObject_HashTable<" + typeof(TKey).ToString() + ", " + typeof(TValue).ToString() + "> is different from the serialized IndexObject_HashTable<" + KeyType.ToString() + ", " + ValueType.ToString() + ">!");
