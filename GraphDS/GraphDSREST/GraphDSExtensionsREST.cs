...
namespace sones.GraphDS.Connectors.REST
{
    ...
    public static class GraphDSExtensionsREST
    {
        ...
        /// <param name="myHttpWebSecurity">A HTTPSecurity class for checking security parameters like user credentials</param>
        public static Exceptional<HTTPServer<GraphDSREST_Service>> StartREST(this AGraphDSSharp myAGraphDSSharp, UInt16 myPort, HTTPSecurity myHttpWebSecurity = null)
        {
        ...
        /// <param name="myPort">The port for binding the interface at</param>
        /// <param name="myHttpWebSecurity">A HTTPSecurity class for checking security parameters like user credentials</param>
        public static Exceptional<HTTPServer<GraphDSREST_Service>> StartREST(this AGraphDSSharp myAGraphDSSharp, IPAddress myIPAddress, UInt16 myPort, HTTPSecurity myHttpWebSecurity = null)
        {
            ...
            try
            {
                ...
                return new Exceptional<HTTPServer<GraphDSREST_Service>>(_HttpWebServer);

            }
            catch (Exception e)
            {
                return new Exceptional<HTTPServer<GraphDSREST_Service>>(new GeneralError(e.Message, new System.Diagnostics.StackTrace(e)));
            }
